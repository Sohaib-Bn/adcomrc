  ...
  return (
    <div className="relative h-screen">
      <div>
        ...
        />
        <img
          className="h-[4.5rem] 2xl:h-[6rem] absolute right-[6.5rem] top-[4rem] 2xl:top-[4.3rem]"
          src="/Untitled-6.png"
          alt="bg"
        />
        <img
      ...
      <div className="z-10 relative h-full flex flex-col">
        ...
        <main className="flex-1 px-[9.5rem] py-[1rem] 2xl:py-[2rem] flex items-center">
          <div className="grid grid-cols-4 gap-x-10 2xl:gap-x-12 gap-y-16 2xl:gap-y-20 w-full">
            {DEPARTEMENT.map((dep) => (
...
function DepartmentLink({ data: { link, label } }) {
  return (
    ...
    >
      <span className="font-extrabold text-[1.6rem] 2xl:text-[1.8rem] leading-[1]">
        {label}
      </span>
      <span className="text-[1.5rem] 2xl:text-[1.5rem] font-light leading-[1]">
        center
      </span>
    </a>
  );
